export const translations = {
  ro: {
    ...
    services: {
      badge: "Ce putem face pentru tine",
      title: "Serviciile Noastre",
      subtitle: "Indiferent de natura evenimentului tău, avem expertiza și echipamentul necesar pentru a livra un sunet de neuitat.",
      s1_title: "Concerte & Live Acts",
      s1_desc: "Sonorizare profesională pentru trupe live, artiști și festivaluri, asigurând claritate și putere pentru fiecare instrument.",
      s2_title: "Evenimente Corporate",
    ...
    equipment: {
      ...
      subtitle: "Dispunem de o gamă largă de echipament, capabile de până la",
      capacity: "300-500 persoane",
      subtitle2: ". Folosim doar branduri de top pentru a asigura fiabilitatea.",
      cap_label: "Capacitate Persoane",
      more: "+ multe altele"
    },
    instagram: {
      badge: "Social Media",
      title: "Urmărește-ne pe Instagram",
      subtitle: "Fii la curent cu cele mai noi evenimente, setup-uri de echipamente și momente din culise."
    },
    cta: {
      title1: "Pregătit pentru un",
      title2: "sunet perfect",
      subtitle: "Lasă-ne să ne ocupăm de partea tehnică, în timp ce tu te bucuri de eveniment. Contactează-ne pentru o ofertă personalizată.",
      quote: "Cere o ofertă",
      call: "Sună-ne acum"
    },
    contact_box: {
  ...
  en: {
    ...
    services: {
      badge: "What we can do for you",
      title: "Our Services",
      subtitle: "Regardless of the nature of your event, we have the expertise and equipment to deliver an unforgettable sound.",
      s1_title: "Concerts & Live Acts",
      s1_desc: "Professional sound for live bands, artists, and festivals, ensuring clarity and power for every instrument.",
      s2_title: "Corporate Events",
    ...
    equipment: {
      ...
      title: "Our Equipment",
      subtitle: "We have a wide range of equipment, capable of handling up to",
      capacity: "300-500 people",
      subtitle2: ". We only use top brands to ensure reliability.",
      cap_label: "People Capacity",
      more: "+ many more"
    },
    instagram: {
      badge: "Social Media",
      title: "Follow us on Instagram",
      subtitle: "Stay up to date with the latest events, equipment setups, and behind-the-scenes moments."
    },
    cta: {
      title1: "Ready for",
      title2: "perfect sound",
